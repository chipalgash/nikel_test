...
from validation import validate_answers_batch
...
def split_text_into_chunks(text: str, max_chars: int = 1200, overlap: int = 200) -> List[str]:
...
def answer_questions():
    ...
    # Создаем ретривер с настройками батчинга
    retriever = Retriever()  # Можно настроить размер батча
    generator = Generator()
    ...
    validation_results = validate_answers_batch(QUESTIONS, generated_answers, ANSWERS)
